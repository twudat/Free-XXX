...
def mainMenu():
    ...
    c = []
    c += [
        (kodi.giveColor('Welcome to FREE-XXX-O-DUS Version %s' % kodi.get_version(), 'blue', True),
             translatePath(os.path.join(kodi.addonfolder,'resources/files/information.txt')), 17, 'icon',
             'Original Code by EchoCoder, Updates by @Nemzzy668, Freedom by Twudat', False),

        ('[COLOR yellow]View Changelog[/COLOR]', translatePath(os.path.join(kodi.addonfolder,
         'resources/files/changelog.txt')), 17, 'changelog', 'View FREE-XXX-O-DUS Changelog.', False),
        ...
        # ('Debug Versions',None,45,'addon_info','View the versions of FRGitUrlEEXXXODUS and its dependencies for debugging.',True),
...
# Check FREE-XXX-O-DUS Health
# re-instated and fixed the echo coder original version of this.
#its now redundant
