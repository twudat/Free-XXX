...
specific_icon       = translatePath(os.path.join('special://home/addons/script.freexxxodus.artwork/resources/art/', '%s/icon.png'))
specific_fanart     = translatePath(os.path.join('special://home/addons/script.freexxxodus.artwork/resources/art/', '%s/fanart.jpg'))
search_icon = translatePath(os.path.join('special://home/addons/script.freexxxodus.artwork/resources/art/', 'main/search.png'))
    ...
    if term:
        ...
        if site=='all':
            ...
            if search_sources:
                ...
                if PY2: dp.create(kodi.get_name(),'',line2,'')
                else: dp.create(kodi.get_name(),line2)
                ...
                for u in sorted(search_sources):
                    ...
                    try:
                        ...
                        if PY2: dp.update(progress, line1 % u.title(),line2 % str(source_num),line3 % str(i))
                        else: dp.update(int(progress), line1 % u.title() + '\n' + line2 % str(source_num) + '\n' + line3 % str(i))
...
def searchHistory(name,url):
    ...
    lst = [('New Search...',mode,'null','Search FREE-XXX-O-DUS',True),('Clear History',15,'url',None,False), \
