...
def menu():
	...
	# for i in r:
		# try:
			...
			# icon = translatePath(os.path.join('special://home/addons/script.freexxxodus.artwork', 'resources/art/%s/icon.png' % base_name))
			# fanarts = translatePath(os.path.join('special://home/addons/script.freexxxodus.artwork', 'resources/art/%s/fanart.jpg' % base_name))
